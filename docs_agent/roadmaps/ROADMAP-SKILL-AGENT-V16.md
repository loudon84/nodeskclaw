...
updated_at: 2026-09-08T14:55:00Z
...
- RM-16 校验标准以 Stage PRD v1.6.15 为准：live 出口为 PC-01 / PC-02 / PC-03 / PC-04 / PC-06 / PC-07 / PC-09 与 PC-12 扫描。**禁止再测 PC-05 Worker kill 与 PC-08 Hermes restart**；二者改由既有 Worker fencing / `interrupted` 单测证明，缺 `RM16_WORKER_KILL_CMD` / `RM16_HERMES_RESTART_CMD` 不得再作为 BLOCKED 出口。禁止 stub、ChatCompletion mock 结项。RM-02 继续 `BACKLOG`，其 Conformance 出口待本项按新标准关闭后的 live 包，本次不得把 RM-02 标 `DONE`。
