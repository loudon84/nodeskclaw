...
_MESSAGE_KEY_MAP: dict[str, str] = {
    ...
    "errors.mcp.catalog_addressing_not_allowed": MCP_INVALID_ARGUMENTS,
    ...
    "errors.task.not_found": MCP_TOOL_NOT_FOUND,
    "errors.task.forbidden": MCP_TOOL_PERMISSION_DENIED,
