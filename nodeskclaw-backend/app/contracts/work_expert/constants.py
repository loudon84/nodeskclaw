...
WORK_EXPERT_CONTRACT_VERSION = "1.0.1"
WORK_EXPERT_CONTRACT_PATH = "/contracts/work-expert/v1.0.1/"
WORK_EXPERT_TAG_NAME = "work-expert-contract-v1.0.1"
WORK_EXPERT_FROZEN_VERSIONS = ("1.0.0",)
