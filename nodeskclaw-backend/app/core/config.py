...
class Settings(BaseSettings):
    ...
    KNOWLEDGE_AUTH_PROOF_TIMEOUT_SECONDS: float = 5.0
    SKILL_RUN_DISPATCHER_ENABLED: bool = True
    SKILL_RUN_DISPATCHER_INTERVAL_SECONDS: int = 2
    SKILL_RUN_DISPATCHER_BATCH_SIZE: int = 10
    SKILL_RUN_DISPATCHER_LEASE_SECONDS: int = 30
    SKILL_RUN_PROJECTION_ENABLED: bool = True
    SKILL_RUN_PROJECTION_INTERVAL_SECONDS: int = 2
    SKILL_RUN_PROJECTION_BATCH_SIZE: int = 10

    EDGE_CONTROL_ISSUER_KEY_ID: str = ""
    EDGE_CONTROL_ISSUER_PRIVATE_KEY: str = ""
    EDGE_CONTROL_ISSUER_KEY_ID_PREVIOUS: str = ""
    EDGE_CONTROL_ISSUER_PRIVATE_KEY_PREVIOUS: str = ""
    EDGE_CONTROL_ISSUER_ROTATION_EXPIRES_AT: str = ""
    EDGE_CONTROL_CLOCK_SKEW_SECONDS: int = 60
    EDGE_CONTROL_BOOTSTRAP_TTL_SECONDS: int = 900
    EDGE_CONTROL_ROTATION_WINDOW_SECONDS: int = 3600
    EDGE_CONTROL_COMMAND_TTL_SECONDS: int = 300
