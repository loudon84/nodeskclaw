...
与 Agent Attempt 上的 Hermes Binding（[[architecture/skill-agent#Hermes Engine Adapter#Attempt Runtime Binding]]）不是同一 Capability，禁止混 Owner。也不是 RM-16 live 的 Run-Bound HermesAgentInstance，见 [[architecture/skill-agent#RM-16 Live Conformance]]。
