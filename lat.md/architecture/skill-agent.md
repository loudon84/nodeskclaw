...
- **目标状态**：implementation `b9f71a253ce722a69e79272d38cf1dab1b6c2f9c`；证据 `docs_agent/evidence/rm16-verification.md`。禁止再测 PC-05 / PC-08 live；禁止 mock OpenAI 字段结项；不得改写 v1.2.1，不得恢复 ChatCompletion parser。RM-02 仍 `BACKLOG`。
...
- **已实现**：2026-09-08 REAL_PROCESS JSON 已跟踪为 `docs_agent/evidence/RM-16-live-*.json`（pc01/pc02/pc03_approve/pc03_deny/pc04/pc06/pc07/pc09/pc12_scan 与 rm02-package 均为 PASS）。PC-03 Native `/approval` 接受。`chat_completions_observed=false`，`runtime_binding_verified=true`。历史 pc05/pc08 `BLOCKED` 文件不是出口。Roadmap `DONE` 与 implementation `b9f71a253ce722a69e79272d38cf1dab1b6c2f9c` 分 commit。RM-02 继续 `BACKLOG`，Revalidation Link 只引用本套件（不含 pc05/pc08 live），不得把 RM-02 标 `DONE`。
- **目标状态**：`--scenario pc05` / `pc08` 保持拒绝；RM-02 独立重证，不得与 RM-16 `DONE` 混标。
