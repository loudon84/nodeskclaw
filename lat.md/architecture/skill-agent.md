...
- **目标状态**：implementation `b9f71a253ce722a69e79272d38cf1dab1b6c2f9c`；证据 `docs_agent/evidence/rm16-verification.md`。禁止再测 PC-05 / PC-08 live；禁止 mock OpenAI 字段结项；不得改写 v1.2.1，不得恢复 ChatCompletion parser。RM-02 独立重证，不得与 RM-16 `DONE` 混标。
