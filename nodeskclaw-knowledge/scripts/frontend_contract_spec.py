...
SCHEMAS: dict[str, dict] = {
    ...
    "source-file-chunk": _schema_doc(
        ...
        _obj(
            ...
            ["id", "content", "available", "has_image", "important_keywords", "questions"],
            extra=False,
        ),
    ),
...
MATRIX: list[dict] = [
    ...
    _ep(
        ...
        notes="active version only; page/page_size request echo; keywords; total from provider; has_image projection",
    ),
    _ep(
        "F16",
        "PATCH",
    ...
    _ep(
        "F17",
        "GET",
        "/api/v1/source-files/{source_file_id}/chunks/{chunk_id}/image",
        stability="stable",
        surface="documents",
        response=None,
        content_type="image/png",
        envelope="binary",
        notes="file_version_id query guard; MIME allowlist png/jpeg/webp/gif; 20MiB cap; no Content-Disposition attachment; no provider image ids",
    ),
