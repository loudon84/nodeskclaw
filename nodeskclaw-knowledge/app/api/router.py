...
from app.api.source_connectors import kb_connectors_router, router as source_connectors_router
...
api_router.include_router(kb_connectors_router)
...
api_router.include_router(source_connectors_router)
