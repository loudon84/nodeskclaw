...
class SourceFileVersion(BaseModel):
    ...
    origin_connector_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    origin_external_revision: Mapped[str | None] = mapped_column(String(256), nullable=True)
    origin_etag: Mapped[str | None] = mapped_column(String(256), nullable=True)
